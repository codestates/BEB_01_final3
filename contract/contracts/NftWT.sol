...
contract WATTONFT is ERC721URIStorage, Ownable {
   ...
   // 5. purchaseToken함수를 사용해서 seller 와 buyer간에 교환이 이루어 질 수 있다.
    ...
    // function TrnasferFom(address receipent,uint256 amount,address _contract)public {
       
    //  (bool success, ) = _contract.call(abi.encodeWithSignature("send(address,uint256)",receipent,amount));
    // }
