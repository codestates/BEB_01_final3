...
router.post("/uploadVideo", (req, res) => {
  //비디오 정보들을 저장한다.
  const video = new UserVideo(req.body);
  video.save((err, doc) => {
...
router.get("/getVideos", (req, res) => {
  ...
  UserVideo.find() //UserVideo collection에있는 모든 데이터들을 찾는다.
...
router.post("/getVideoDetail", (req, res) => {
  console.log('UsUdetail',req.body);
  UserVideo.findOne({ _id: req.body.videoId })
    .populate("writer")
